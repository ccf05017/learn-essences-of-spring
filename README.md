...
#### Section20.
- 모듈화를 통해 소프트웨어의 구조를 표현할 수 있다.
- 스프링은 AOP, 서비스 추상화 등의 기능을 통해 모듈화의 이점을 극도로 올려줄 수 있다.
- 스프링은 각종 기능설정 모듈화 어노테이션들을 제공한다.
  - 예를 들면, EnableCaching, EnableAsync 등등
  - 이렇게 등록된 설정들은 Bean 설정으로 세부조정이 가능하다.
